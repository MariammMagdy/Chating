...
We received a request to verify your Chatter Account.
${verificationCode}
...
exports.protectforget = asyncHandler(async (req, res, next) => {
    ...
    if (currentUser.passwordChangeAt) {
        const passChangedTimestamp = parseInt(currentUser.passwordChangeAt / 1000,10);
        if (passChangedTimestamp > decoded.iat) {
...
exports.forgotPassword = asyncHandler(async (req, res, next) => {
    ...
    const message = `Hi ${user.name},\n\nWe received a request to reset your Chatter Account password.\n\nYour reset code is: ${resetCode}\n\nThanks,\nChatter Team`;
